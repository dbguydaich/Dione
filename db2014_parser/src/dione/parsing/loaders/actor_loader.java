...
/**
 * class for loading to actor table
 * @author GUY
 *
 */
public class actor_loader extends abstract_loader {
	 ...
	 * constructor
	 * @param importer 
	 * @param parser_map_actor - actors to load
	 * @throws SQLException
	 */
	public actor_loader(Importer importer, HashMap<String, entity_person> parser_map_actor) throws SQLException {
		super(importer,parser_map_actor.values());
