...
public class movie_comments_window extends abstract_window
{
	...
	public movie_comments_window(final Display display, final int movie_id)
	{
		...
		/* comments */
		List<String> movie_comments = new ArrayList<String>();
		//movie comments = get_recent_movie_comments(movie_id); limit to 12!
		
		//just for check
		movie_comments.add("1234567890: 1111111111222222222233333333334444444444555555555566666666667777777777");
		movie_comments.add("1234567890: 1111111111222222222233333333334444444444555555555566666666667777777777");
		movie_comments.add("1234567890: 1111111111222222222233333333334444444444555555555566666666667777777777");
		movie_comments.add("1234567890: 1111111111222222222233333333334444444444555555555566666666667777777777");
		movie_comments.add("1234567890: 1111111111222222222233333333334444444444555555555566666666667777777777");
