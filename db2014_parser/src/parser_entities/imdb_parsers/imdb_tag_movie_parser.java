...
public class imdb_tag_movie_parser extends abstract_imdb_parser {
	...
	/**
	 * @param line
	 *            - a line to handle Parse IMDB tags file. Parse titles and
	 *            their tags. if Parsed title agrees with yago name, year and
	 *            director, enrich Yago movie with the MAX_TAGS most popular
	 *            tags, for this movie
	 **/
